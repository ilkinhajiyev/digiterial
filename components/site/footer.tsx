...
export default async function SiteFooter() {
  ...
  return (
    <footer className="pt-24 pb-9 border-t border-white/10 bg-[#060807]">
      <div className="wrap">
        ...
        <div className="font-display font-semibold text-[clamp(3rem,14vw,11rem)] tracking-[-.07em] leading-none mt-16 flex items-end text-white/95">{(st.brand || 'digiterial').toLowerCase()}<span className="w-3.5 h-3.5 rounded-full bg-brand ml-1.5 mb-[.08em]" /></div>
